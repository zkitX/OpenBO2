...
#define LOBYTE_(x)  BYTEn(x,LOW_IND(x,_BYTE))
#define LOWORD_(x)  WORDn(x,LOW_IND(x,_WORD))
#define LODWORD(x) DWORDn(x,LOW_IND(x,_DWORD))
#define HIBYTE_(x)  BYTEn(x,HIGH_IND(x,_BYTE))
#define HIWORD_(x)  WORDn(x,HIGH_IND(x,_WORD))
