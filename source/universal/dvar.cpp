...
void Dvar_UpdateEnumDomain(const dvar_t* dvar, const char** stringTable)
{
    ...
    *((_QWORD*)&v8.string + 1) = *((_QWORD*)&dvar->reset.string + 1);
    v9.integer64 = dvar->current.integer64;
    *((_QWORD*)&v9.string + 1) = *((_QWORD*)&dvar->current.string + 1);
...
void Dvar_UpdateResetValue(DvarValue value)
{
    ...
    case 5:
        v2->reset.integer64 = resetString.integer64;
        *((_QWORD*)&v2->reset.string + 1) = *((_QWORD*)&resetString.string + 1);
        break;
    case 6:
    case 7:
    case 9:
...
void Dvar_UpdateValue(dvar_t* dvar, DvarValue value)
{
    ...
    case 0xC:
        ...
        v6 = *(__int64*)((char*)&currentString.integer64 + 4);
        dvar->current.integer = currentString.integer;
        *(__int64*)((char*)&dvar->current.integer64 + 4) = v6;
        dvar->latched.integer = v5;
        *(__int64*)((char*)&dvar->latched.integer64 + 4) = v6;
        break;
    case 5:
        v7 = currentString.integer;
        v8 = *(__int64*)((char*)&currentString.integer64 + 4);
        v9 = currentString.vector.v[3];
        dvar->current.integer = currentString.integer;
        *(__int64*)((char*)&dvar->current.integer64 + 4) = v8;
        dvar->current.vector.v[3] = v9;
        dvar->latched.integer = v7;
        *(__int64*)((char*)&dvar->latched.integer64 + 4) = v8;
    ...
    case 8:
        if (currentString.integer != dvar->current.integer)
        {
            ...
            dvar->current.integer = currentString.integer;
            if ((unsigned __int8)Dvar_ShouldFreeLatchedString(dvar))
...
bool Dvar_ValueInDomain(dvarType_t type, DvarValue value, DvarLimits domain)
{
    ...
    case 10:
        ...
        if (SLODWORD(v11.vector.v[1]) <= domain.integer.max
            ...
            || SLODWORD(v11.vector.v[1]) >= *((_DWORD*)&domain.vector + 3)
            && (SLODWORD(v11.vector.v[1]) > * ((_DWORD*)&domain.vector + 3)
                || (unsigned int)v11.integer > * ((_DWORD*)&domain.vector + 2)))
        {
            return 0;
        }
        return 1;
...
void dvar::Dvar_LoadDvarsAddFlags(MemoryFile* memFile, unsigned __int16 flags)
{
}
...
void dvar::Dvar_StringToColor(char* color, const char* string)
{
    ...
    *(_QWORD*)colorVec.v = 0i64;
    *(_QWORD*)&colorVec.b = 0i64;
...
__int64 dvar::Dvar_StringToInt64(const char* string)
{
    if (!string
        && !assertive::Assert_MyHandler(__FILE__, __LINE__, 0, "(string)", (const char*)&pBlock))
    {
...
DvarValue* dvar::Dvar_StringToValue(const dvarType_t type, const char* string, double a3, const DvarLimits domain)
{
    ...
    {
    case DVAR_TYPE_BOOL:
        *(_BYTE*)domain.enumeration.stringCount = Dvar_StringToBool(v5);
        break;
    ...
    case 5:
        ...
        break;
    case 6:
        *(_DWORD*)domain.enumeration.stringCount = Dvar_StringToInt(v5);
        break;
    case 7:
        *(_DWORD*)domain.enumeration.stringCount = Dvar_StringToEnum((const DvarLimits*)((char*)&domain + 4), v5);
        break;
    case 8:
        *(_DWORD*)domain.enumeration.stringCount = (int)v5;
        break;
    case 9:
        Dvar_StringToColor((char*)v5, (char*)domain.enumeration.stringCount);
        break;
    case 10:
        *(_QWORD*)domain.enumeration.stringCount = Dvar_StringToInt64(v5);
        break;
    }
}
...
#endif // _DEBUG
    * (_QWORD*)vector->v = 0i64;
    *(_QWORD*)&vector->b = 0i64;
...
char dvar::Dvar_ToggleSimple(const dvar_t* dvar)
{
    ...
    int v10; // edi
    int v11; // eax
    __int64 domain_value_max; // [esp+10h] [ebp-Ch]
    ...
    case DVAR_TYPE_INT64:
        ...
        domain_value_max = v6;
        if (SHIDWORD(v5) > 0 || v5 >= 0 && (_DWORD)v5 || v6 < 1)
        {
...
const char* dvar::Dvar_ValueToString(const dvar_t* dvar, DvarValue value)
{
    ...
    case 9:
        result = va(
            ...
            (float)((float)(unsigned __int8)value.color[1] * 0.0039215689),
            (float)((float)(unsigned __int8)value.color[2] * 0.0039215689),
            (float)((float)(unsigned __int8)value.color[3] * 0.0039215689));
        break;
    case 0xA:
